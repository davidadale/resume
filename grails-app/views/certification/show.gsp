...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Cert Date:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:certificationInstance, field:'certDate')}</td>
            ...
            <div class="buttons">
                <g:form>
                    <input type="hidden" name="id" value="${certificationInstance?.id}" />
