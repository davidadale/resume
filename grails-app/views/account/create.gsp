                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="verifiedPassword">Verified Password:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean:accountInstance,field:'verifiedPassword','errors')}">
                                    <input type="text" id="verifiedPassword" name="verifiedPassword" value="${fieldValue(bean:accountInstance,field:'verifiedPassword')}"/>
                                </td>
                            </tr> 
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="passwordVerified">Password Verified:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean:accountInstance,field:'passwordVerified','errors')}">
                                    <g:checkBox name="passwordVerified" value="${accountInstance?.passwordVerified}"></g:checkBox>
                                </td>
                            </tr> 
